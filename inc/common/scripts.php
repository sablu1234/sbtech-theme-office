...
function add_theme_scripts() {
    ...
    wp_enqueue_style('page-agent-single', get_template_directory_uri() . '/assets/css/agent-single.css', array(), '1.0.0', 'all');
    ...
    wp_enqueue_script('page-index-js', get_template_directory_uri() . '/assets/js/page-index-js.js', array('jquery'), "1.0.1", true);
