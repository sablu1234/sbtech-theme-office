...
/**
 * Plugin Name: Porpertypi AJAX Filter (pp_purpose / pp_status dynamic)
 * Version: 1.0.0
 */
...
add_action('wp_enqueue_scripts', function () {
    ...
    :root{--f:Poppins,system-ui;--t:#0f172a;--m:#64748b;--l:#e5e7eb;--b:#0b63ce;--b2:#0a56b3;--s:0 10px 30px rgba(2,8,23,.08);--r:14px}
    .re-wrap{max-width:1200px;margin:0 auto;padding:16px;font-family:var(--f)}
    ...
    .re-results{margin-top:14px;min-height:120px}
