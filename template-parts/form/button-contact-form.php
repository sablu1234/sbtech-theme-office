...
add_action('wp_enqueue_scripts', 'bcf_direct_enqueue_select2_assets');
function bcf_direct_enqueue_select2_assets(){
  wp_enqueue_style(
    'bcf-direct-select2',
  ...
  wp_add_inline_script('bcf-direct-select2', <<<'JS'
(function($){
  'use strict';

  function bcfFormatCountry(option){
    if (!option.id) {
      return option.text;
    }

    var flagUrl = $(option.element).data('flag-url');
    var $item = $('<span class="bcf-select2-country"></span>');
  ...
  function bcfInitCountrySelect2(context){
    var $context = context ? $(context) : $(document);

    $context.find('.button_contact_form-country-select').each(function(){
      var $select = $(this);
      ...
      $select.select2({
        ...
        dropdownParent: $select.closest('.button_contact_form-field'),
        dropdownCssClass: 'button_contact_form-select2-dropdown',
        templateResult: bcfFormatCountry,
        templateSelection: bcfFormatCountry
      });
    });
  }

  $(window).on('load', function(){
    bcfInitCountrySelect2(document);
  });

  $(document).on('bcf:initSelect2', function(e, context){
    bcfInitCountrySelect2(context || document);
  });
})(jQuery);
JS
  );
...
add_shortcode('button_contact_form_direct', function($atts){
  ...
  <style>
    ...
    /* Select2 country flag dropdown */
    .button_contact_form-field{
      position:relative;
    }
    .button_contact_form-phone .select2-container{
      width:160px !important;
      flex:0 0 160px;
      max-width:160px;
      min-width:160px;
    }
    .button_contact_form-section .select2-container--default .select2-selection--single{
      height:46px;
      border:1px solid rgba(0,0,0,.12);
      border-radius:14px;
      background:#fff;
    ...
    .button_contact_form-section .select2-container--default .select2-selection--single .select2-selection__rendered{
      width:100%;
      height:46px;
      line-height:46px;
      padding-left:12px;
    ...
    .button_contact_form-section .select2-container--default .select2-selection--single .select2-selection__arrow{
      height:46px;
      right:8px;
    }
    .button_contact_form-section .select2-container--default.select2-container--focus .select2-selection--single,
    .button_contact_form-section .select2-container--default.select2-container--open .select2-selection--single{
      border-color:rgba(239,60,38,.6);
      box-shadow:0 0 0 4px rgba(239,60,38,.12);
    }
    .bcf-select2-country{
    ...
    .button_contact_form-field .select2-container--open,
    .select2-container--open{
      z-index:999999 !important;
    }
    .select2-dropdown.button_contact_form-select2-dropdown{
      z-index:999999 !important;
      border:1px solid rgba(0,0,0,.12);
      border-radius:14px;
      overflow:hidden;
    ...
    .select2-dropdown.button_contact_form-select2-dropdown .select2-results__options{
      max-height:260px;
      overflow-y:auto;
    }
    .select2-dropdown.button_contact_form-select2-dropdown .select2-results__option{
      padding:9px 12px;
    }
    .select2-dropdown.button_contact_form-select2-dropdown .select2-results__option--highlighted[aria-selected]{
      background:var(--clr-primary, #ef3c26);
      color:#fff;
    }
    ...
    /* Select2 layout fix - keep same height/alignment as phone input */
    .button_contact_form-phone{
      align-items:stretch !important;
    }
    .button_contact_form-phone .button_contact_form-input{
      flex:1 1 auto;
      min-width:0;
      height:48px;
    }
    ...
    .button_contact_form-phone .select2-container .selection,
    .button_contact_form-phone .select2-container .select2-selection{
      height:48px !important;
    }
    .button_contact_form-section .select2-container--default .select2-selection--single{
      height:48px !important;
    ...
    .button_contact_form-section .bcf-select2-country{
      line-height:1 !important;
      align-items:center !important;
    }
    .button_contact_form-section .bcf-select2-country img{
      display:block !important;
  ...
  <?php
  $contact_us_button_checkbox_text = get_theme_mod( 'contact_us_button_checkbox_text', 'I agree to receive information about offers, deals and services from this website (optional).' );
  ?>
          ...
          <form class="button_contact_form-form" action="<?php echo $action_url; ?>" method="post">
            ...
            <div class="button_contact_form-field">
              ...
              <div class="button_contact_form-phone">
                <select class="button_contact_form-select button_contact_form-country-select" name="country_code" aria-label="Country code">
            ...
            <label class="button_contact_form-check">
              ...
              <span><?php echo esc_html($contact_us_button_checkbox_text); ?></span>
            </label>
