            ...
            <div class="career_card">
                ...
                <form class="career_form" method="post" enctype="multipart/form-data" action="<?php echo esc_url(admin_url('admin-post.php')); ?>">
                    ...
                    <div class="career_recaptcha_wrap" id="careerRecaptchaWrap">
                        <div class="g-recaptcha py-3" data-sitekey="6Ld8NdAsAAAAAMgO-9tp_JHOxQFspATYeLWu-ulo"></div>
                    </div>
...
add_shortcode('newsletter_form', function () {
    ...
    <?php 
        $home_subscribe_title = get_theme_mod( 'home_subscribe_title', __('Our newsletter', 'sbtech') );
        $home_subscribe_desc = get_theme_mod( 'home_subscribe_desc', __('Get weekly updates, new projects and insights.', 'sbtech') );
    ?>
    <div class="newsletter_box">
        <div class="newsletter_row">

            <div class="newsletter_left">
                <?php if (!empty($home_subscribe_title)) : ?>
                <h3 class="newsletter_title"><?php echo esc_html($home_subscribe_title); ?></h3>
                <?php endif; ?>

                <?php if (!empty($home_subscribe_desc)) : ?>
                <p class="newsletter_desc"><?php echo esc_html($home_subscribe_desc); ?></p>
                <?php endif; ?>
        ...
        <div class="newsletter_msg">
            ...
            if (isset($_POST['newsletter_submit'])) {
                ...
                if (empty($recaptcha_response)) {
                    ...
                    $secret_key = '6Ld8NdAsAAAAADZy5t6j_sDzMNMs77cpL5xY70UQ'; // Updated secret key
