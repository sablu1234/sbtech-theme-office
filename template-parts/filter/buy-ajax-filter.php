...
function buy_search_suggestions() {
    ...
    if (count($items) < 8) {
        ...
        $sql_pp_area = $wpdb->prepare("
            ...
            ORDER BY p.post_date DESC
            LIMIT 8
        ", BUY_INDEX_META_EXPIRED_DATE, BUY_INDEX_CPT, BUY_INDEX_META_AREA_PP, $like, date('Y-m-d'));
    ...
    if (count($items) < 8) {
        ...
        $sql_unit = $wpdb->prepare("
            ...
            ORDER BY p.post_date DESC
            LIMIT 8
        ", BUY_INDEX_META_EXPIRED_DATE, BUY_INDEX_CPT, BUY_INDEX_META_UNIT_REFERENCE, $like, date('Y-m-d'));
    ...
    if (count($items) < 8) {
        ...
        $sql_property_type = $wpdb->prepare("
            ...
            ORDER BY p.post_date DESC
            LIMIT 8
        ", BUY_INDEX_META_EXPIRED_DATE, BUY_INDEX_CPT, BUY_INDEX_META_PROPERTY_TYPE, $like, date('Y-m-d'));
