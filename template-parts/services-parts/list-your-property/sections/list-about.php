<?php
function list_your_property_about_shortcode() {
    ob_start();
    ...
    $liyp_subtilte = get_theme_mod( 'liyp_subtilte', 'List Your Property' );
    $liyp_title = get_theme_mod( 'liyp_title', 'Turn Your Property Into Income' );
    $liyp_desc = get_theme_mod( 'liyp_desc', 'Easily list your property and start earning by connecting with the right tenants or buyers. Our platform makes it simple, fast, and secure to showcase your space to thousands of potential clients.' );
    ...
    <div class="property-management-container">
        ...
        <div class="property-management-content">
            ...
            <?php if(!empty($liyp_subtilte)) : ?>
            <p class="property-management-kicker"><?php echo esc_html( $liyp_subtilte )?></p>
            <?php endif;?>

            <?php if(!empty($liyp_title)) : ?>
            <h2 class="property-management-title"><?php echo esc_html( $liyp_title )?> </h2>
            <?php endif;?>

            <div class="property-management-text">
            
            <?php if(!empty($liyp_desc)) : ?>
            <p><?php echo esc_html( $liyp_desc )?></p>
            <?php endif;?>
...
add_shortcode('list_your_property_about', 'list_your_property_about_shortcode');