<?php
function list_your_property_funciton() {
    ob_start();
    ...
    <div class="property-management-container">
        ...
        <div class="property-management-media">
            ...
            <img
                ...
                src="<?php echo $list_your_property_pm_about_img; ?>"
...
add_shortcode('list_your_property_shortcode', 'list_your_property_funciton');