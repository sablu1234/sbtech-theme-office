...
function mortgage_calculator_function() {
                    ...
                    <div class="why-choose-mortgage-form">
                        <div class="why-choose-mortgage-grid">
                            <div class="why-choose-mortgage-field">
                                ...
                                <input class="why-choose-mortgage-input" id="wcm-price" type="number" min="0" step="1000" value="100000">
                            </div>

                            <div class="why-choose-mortgage-field">
                                <div class="why-choose-mortgage-label-wrap">
                                    <label class="why-choose-mortgage-label" for="wcm-down-amount">Down Payment</label>
                                    <span class="why-choose-mortgage-inline-percent" id="wcm-down-percent-show">25.00%</span>
                                </div>
                                <input class="why-choose-mortgage-input" id="wcm-down-amount" type="number" min="0" step="1000" value="10000">
                            </div>

                            <div class="why-choose-mortgage-field">
                                <label class="why-choose-mortgage-label" for="wcm-rate">Interest Rate (%)</label>
                                <input class="why-choose-mortgage-input" id="wcm-rate" type="number" min="0" step="0.01" value="4">
                            </div>

                            <div class="why-choose-mortgage-field">
                                <label class="why-choose-mortgage-label" for="wcm-years">Loan Period (Years)</label>
                                <input class="why-choose-mortgage-input" id="wcm-years" type="number" min="1" step="1" value="20">
                            </div>
                        </div>
    ...
    <script>
        (function(){
            ...
            const downAmountEl = document.getElementById('wcm-down-amount');
            ...
            const downPercentShow = document.getElementById('wcm-down-percent-show');
            ...
            function calc(){
                ...
                downPercentShow.textContent = downPct.toFixed(2) + '%';
                monthlyOut.textContent = fmtAED(M);
                principalOut.textContent = fmtAED(P);
                interestOut.textContent = fmtAED(totalInterest);
                totalOut.textContent = fmtAED(totalPayable);
            }

            ['input', 'change'].forEach(evt => {
                [priceEl, downAmountEl, rateEl, yearsEl].forEach(el => el.addEventListener(evt, calc));
            });
    ...
    <style>
        ...
        .why-choose-mortgage-label-wrap{
            display:flex;
            align-items:center;
            justify-content:space-between;
            gap:10px;
        ...
        .why-choose-mortgage-inline-percent{
            font-size:12.5px;
            font-weight:700;
