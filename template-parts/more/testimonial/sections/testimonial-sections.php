...
add_shortcode('client_trust', function () {
  ...
  <?php
    ...
    $testimonial_desc = get_theme_mod('testimonial_desc', __('Hear directly from our clients about their experience working with our team. Real feedback, trusted results, and proven satisfaction that reflect our commitment to delivering reliable and professional property services.', 'sbtech'));
  ?>
